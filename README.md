...
[![Release](https://img.shields.io/github/v/release/MANROOP-SINGH-01/OpenVoice?include_prereleases&label=release&color=44D62C)](https://github.com/MANROOP-SINGH-01/OpenVoice/releases)
[![CI](https://github.com/MANROOP-SINGH-01/OpenVoice/actions/workflows/ci.yml/badge.svg)](https://github.com/MANROOP-SINGH-01/OpenVoice/actions/workflows/ci.yml)
...
**[⬇ Download for Windows](https://github.com/MANROOP-SINGH-01/OpenVoice/releases/download/download/OpenVoice-x64-setup.exe)** — one `.exe`, speech engine included.
[All releases →](https://github.com/MANROOP-SINGH-01/OpenVoice/releases) · [Docs](https://openvoice-dictation.vercel.app/docs) · [Changelog](https://openvoice-dictation.vercel.app/changelog)
...
Download **[`OpenVoice-x64-setup.exe`](https://github.com/MANROOP-SINGH-01/OpenVoice/releases/download/download/OpenVoice-x64-setup.exe)** and run it. That link always
...
remembering to edit it. The [releases page](https://github.com/MANROOP-SINGH-01/OpenVoice/releases)
...
- Releases are built by public GitHub Actions from a tagged commit, with a
  ...
  The [build log](https://github.com/MANROOP-SINGH-01/OpenVoice/actions/workflows/release.yml)
